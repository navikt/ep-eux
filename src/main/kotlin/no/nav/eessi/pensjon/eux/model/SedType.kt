...
enum class SedType(val beskrivelse: String) {
    ...
    fun kanPrefilles(): Boolean {
        return this in listOf(
            P2000, P2100, P2200, P4000, P6000, P5000, P7000, P8000, P9000, P10000, P14000, P15000, X005, X009,
            X010, X011, H020, H021, H070, H120, H121, P12000, P13000, P1000, P1100, P11000, P3000_FR, P3000_RO, P3000_IE,
            ...
            P3000_LV, P3000_SK, P3000_NL, P3000_GR, P3000_HR, P3000_CY, P3000_LU, P3000_CH, P3000_CZ, P3000_EL,
            M050, M051, M052, M053, R004, R005
        )
    }
}
