...
data class Nav(
        ...
        val krav: Krav? = null, // TODO fix mutable
...
data class RelasjonAvdodItem(
        ...
        val relasjon: RelasjonTilAvdod? = null,  //5.2.5  P2100
...
data class Tilbakekreving(
        ...
        val status: TilbakekrevingStatus? = null
)
...
data class TilbakekrevingStatus(val type: String?)
